...
import { BookOpen, PenTool, Search, LayoutDashboard } from 'lucide-react';
...
export default function MobileLayout({ children }: { children: React.ReactNode }) {
  ...
  const tabs: TabItem[] = [
    { href: '/study', label: '學習', icon: <BookOpen size={22} /> },
    { href: '/test', label: '測驗', icon: <PenTool size={22} /> },
    { href: '/dictionary', label: '字典', icon: <Search size={22} /> },
    { href: '/dashboard', label: '儀表板', icon: <LayoutDashboard size={22} /> },
  ];
